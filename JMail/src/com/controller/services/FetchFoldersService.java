...
public class FetchFoldersService extends Service<Void> {
    ...
    private void handleFolders(Folder[] folders, EmailTreeItem<String> foldersRoot) throws MessagingException {
        for(Folder folder : folders) {
            ...
            fetchMessages(folder, emailTreeItem);
    ...
    private void addMessageListenerToFolder(Folder folder, EmailTreeItem<String> emailTreeItem) {
        folder.addMessageCountListener(new MessageCountListener() {
            ...
            public void messagesAdded(MessageCountEvent messageCountEvent) {
                System.out.println("Message added event...! " + messageCountEvent); // Testing message
            ...
            public void messagesRemoved(MessageCountEvent messageCountEvent) {
                System.out.println("Message removed event...! " + messageCountEvent); // Testing message
            }
        });
    }

    private void fetchMessages(Folder folder, EmailTreeItem<String> emailTreeItem) {
